...
Neural surrogate models for CFD usually learn to map explicit inputs, such as geometry and boundary conditions, to solution fields, limiting their reuse when boundary conditions shift or local geometry changes. Here, we reformulate steady CFD inference as an inpainting problem: We learn a self-supervised prior over velocity fields, and impose boundary constraints only at inference by fixing known regions, such as inlets, outlets, or unchanged simulation context. Our results suggest that viewing CFD inference as context-conditioned inpainting can turn neural surrogates from task-specific predictors into reusable flow priors.
...
[[Paper]](https://icml.cc/virtual/2026/poster/66563) | [[Code]](https://rank-inrs.github.io/)
